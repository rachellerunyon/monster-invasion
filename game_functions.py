...
def check_play_button(ai_settings, screen, stats, sb, play_button, arrow,
    ...
    if button_clicked and not stats.game_active:
        ...
        start_game(ai_settings, screen, stats, sb, arrow, monsters, bullets)
...
def check_events(ai_settings, screen, stats, sb, play_button, arrow, monsters,
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, ai_settings, screen, stats, sb, arrow, monsters, bullets)
...
def check_keydown_events(event, ai_settings, screen, stats, sb, arrow, monsters,
                         bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        fire_bullet(ai_settings, bullets, screen, arrow)
...
def fire_bullet(ai_settings, bullets, screen, arrow):
...
def start_new_level(ai_settings, monsters, bullets, sb, screen, arrow, stats):
...
def check_monsters_bottom(ai_settings, stats, screen, sb, arrow, monsters, bullets):
    ...
    for monster in monsters.sprites():
        if monster.rect.bottom >= screen_rect.bottom:
            ...
            arrow_hit(ai_settings, stats, screen, sb, arrow, monsters, bullets)
            break


def update_monsters(ai_settings, stats, screen, sb, arrow, monsters, bullets):
    ...
    check_monsters_bottom(ai_settings, stats, screen, sb, arrow, monsters, bullets)
...
def arrow_hit(ai_settings, stats, screen, sb, arrow, monsters, bullets):
...
def start_game(ai_settings, screen, stats, sb, arrow, monsters, bullets):
